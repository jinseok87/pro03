				...
				<form name="frm1" id="frm1" action="${path1 }/AddTourCtrl.do" method="post" onsubmit="return tourCheck(this)">
					...
					<div class="field">
						...
						<div class="control has-icons-left has-icons-right">
							<input class="input is-gray" type="text" name="place" id="place" placeholder="장소 입력" required>
						...
						<p class="help is-gray">장소명을 입력하세요</p>
					</div>
					...
					<div class="field">
						...
						<p class="help is-gray">장소의 주요설명을 넣어 주시기 바랍니다.</p>
					</div>
					...
					<div class="field">
						...
						<p class="help is-gray">장소의 상세설명을 넣어 주시기 바랍니다.</p>
					</div>
					...
					<div class="field">
						...
						<div class="control">
							...
							<button type="button" class="button " onclick="imgUpload(1)">이미지 추가</button>
						</div>
					</div>

					<div class="field is-grouped">
						<div class="control">
							<button type="submit" class="button ">장소 등록</button>
						</div>
						<div class="control">
