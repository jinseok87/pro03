...
<body>
	<form name="upload" id="upload" action="${path1 }/ImgUploadCtrl.do" method="post" enctype="multipart/form-data">
		<table class="table">
			<tr>
				<th>위치</th>
				<td><input type="number" name="pos" id="pos" class="input" value="<%=no%>" /></td>
			</tr>
			<tr>
				<th>장소 번호</th>
				<td><input type="text" name="tourno" id="tourno" class="input" value="<%=tourno%>" readonly /></td>
			</tr>
			<tr>
				<th>업로드 파일</th>
				<td>
			...
			<tr>
				<td colspan="2">
					<div class="field is-grouped">
						<div class="control">
							<button type="button" class="button " onclick="fileUpload()">파일 업로드</button>
						</div>
						<div class="control">
							<button type="reset" class="button is-link ">취소</button>
						</div>
						<div class="control">
							<button type="button" class="button is-link " onclick="picCheck()">확인</button>
						</div>
						<div class="control">
							<button type="button" class="button is-link " onclick="window.close()">닫기</button>
						</div>
					</div>
				</td>
			</tr>
